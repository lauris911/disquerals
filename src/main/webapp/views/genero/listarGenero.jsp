...
<form>
    ...
    <c:forEach var="generosList" items="${generosList}">
        <tr>
        <td>${generosList.getIdGenero()}</td>
        <td>${generosList.getNombreGenero()}</td>
        
        <c:if test="${generosList.getEstadoGenero() == true}">
            <td>
                <span>Genero Activo</span>
            </td>
        </c:if>

        <c:if test="${generosList.getEstadoGenero() == false}">
            <td>
        ...
        <td>
            <c:if test="$generosList.getEstadoGenero() == true}">
            <a href="genero?accion=estadoGenero&idGenero=${generosList.getIdGenero()}&estadoGenero=false"><button>Inactivar</button></a>
            </c:if>
            <c:if test="$generosList.getEstadoGenero() == false}">
            <a href="genero?accion=estadoGenero&idGenero=${generosList.getIdGenero()}&estadoGenero=true"><button>Activar</button></a>
            </c:if>
        </td>
        <td>
            <a href="genero?accion=editar&idGenero=${generosList.getIdGenero()}"><button>Editar</button></a>
            <a href="genero?accion=eliminar&idGenero=${generosList.getIdGenero()}"><button>Eliminar</button> </a>
        </td>
        </tr>
    </c:forEach>
</table>
